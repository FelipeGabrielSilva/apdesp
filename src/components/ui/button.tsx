  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-primary bg-background text-primary hover:bg-primary hover:text-primary-foreground shadow-soft transition-smooth",
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-hero transform hover:scale-105 shadow-card transition-bounce font-semibold",
        admin: "bg-brand-blue text-white hover:bg-primary-dark shadow-soft transition-smooth",
      },
      size: {
